    ...
    <main className="dash-content">
      ...
      <section className="dash-card agr-locked-card">
        ...
        <p className="agr-locked-body">
          The Agency unlocks this agreement once we&apos;ve completed verifying
          your TikTok Shop account on our end. Until then, you can read the
          full text below so you know exactly what to expect — but the{" "}
          <strong>Sign</strong> button stays inactive.
        </p>
